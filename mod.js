...
class Server1 {
    ...
    hand = async (req)=>{
        ...
        return new Response(typeof res.reply !== "object" ? res.reply : JSON.stringify(res.reply), {
            status: res.status,
            headers: {
                ...this.dHeaders,
                ...res.headers
...
const __default = (path, moreExp)=>{
    ...
    for(let i = 0; i < path.length; i++){
        ...
        if (c === ":") {
            ...
            str += !moreExp ? `(?<${param}>[a-zA-Z0-9_ %@]+)` : `(?<${param}>[a-zA-Z0-9 !@#\$%\\^\&*\)\(+=._;:]+)`;
            i = j - 1;
        } else {
            str += c;
        }
